...
Notification = function(data, getAdditionalData) {
        ...
        if (getAdditionalData){
            ...
            latestComment.state = "Issue"; //Default
            latestComment.user.login = ""; //Default
            latestComment.user.avatar_url = ""; //Default
        }
    ...
    chrome.storage.local.get(
        ...
        function(items) {
            if (typeof items.lastResponse === 'undefined'){
                ...
                console.log('Populating html from cached data. ' + items.lastResponse.length + ' notifications');
